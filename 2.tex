...
\textbf{Punto 1: }Encontrar expresiones regulares para los siguientes lenguajes definidos sobre el alfabeto $\Sigma=\{a,b\}:$
 \begin{itemize}
    \item [✎] Lenguaje de todas las cadena que comienzan con el símbolo $b$ y terminan con el símbolo $a$.\\ 
    ...
    \item[✎]Lenguaje de todas las cadenas de longitud impar.\\
    ...
    \item[✎] Lenguaje de todas las cadenas que tienen un numero impar de $aes.$\\ 
    ...
    \item[✎]Lenguaje de todas las cadenas en las que el numero de $bes$ es un múltiplo $\geq0$ de 3.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que no comienzan con la subcadena $ba$ ni terminan en $b.$\\ 
    ...
    Ya que tampoco pueden acabar en $b$, ahora no falta notas que por agregar esta $a$ al final y la expresión $(a\cup ab \cup b^2 \cup a^2)$ es imposible obtener la cadena vacía y la cadena $a$, pues las añadimos y nos queda finalmente:
     ...
     \item[✎] Lenguaje de todas las cadenas que no contienen la subcadena $bba.$\\ 
...
\begin{itemize}
    \item[✎] Lenguaje de todas las cadenas que comienzan con 2 y terminan con 1.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que no comienzan con 2 ni terminan en 1.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que tienen un numero par de símbolos.\\
    ...
    \item[✎] Lenguaje de todas las cadenas que tienen un numero impar de símbolos.\\
    ...
    \item[✎] Lenguaje de todas las cadenas que no contienen dos unos consecutivos.\\ 
...
\begin{itemize}
    \item[✎] Lenguaje de todas las cadenas que tienen por lo menos un 0 y por lo menos un 1.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que no contienen tres ceros consecutivos.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas cuya longitud es $\geq4.$\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas cuya longitud es $\geq5$ y cuyo quinto símbolo, de izquierda a derecha, es un 1.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que no terminan en 01.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas de longitud par $\geq2$ formadas por ceros y unos alternados.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas de longitud $\geq2$ formadas por ceros y unos alternados.\\ 
    ...
    \item[✎] Lenguaje de todas las cadenas que no contienen dos ceros consecutivos ni dos unos consecutivos.\\ 
    ...
    Note que si no pueden haber dos ceros seguidos ni dos unos seguidos, los ceros y los unos deben de ir alternados forzosamente, es decir que la solución es la misma que la del ejercicio previo, exceptuando un detalle:
     ...
     \item[✎] Lenguaje de todas las cadenas de longitud impar que tienen unos en todas y cada una de las posiciones impares; en las posiciones pares pueden aparecer ceros o unos.\\
     ...
     \item[✎] Lenguaje de todas las cadenas cuya longitud es un múltiplo de tres.\\
     ...
     Para generar cadenas cuya longitud es un múltiplo de 3, necesitamos todos los bloques de longitud $3$ y posteriormente los concatenamos de todas las formas posibles, es decir tenemos la expresión $\left((0\cup1)^3\right)^*$. Recuerde que $0$ es múltiplo de $3$ por eso usamos el $*$ para asegurar la cadena $\lambda$.
      ...
      \item[✎] Lenguaje de todas las cadenas que no contienen cuatro ceros consecutivos.\\
      ...
      \item[✎] Lenguaje de todas las cadenas que no comienzan con 00 ni terminan en 11.\\
      ...
      \item[✎] Lenguaje de todas las cadenas que no contienen la subcadena 101.\\
