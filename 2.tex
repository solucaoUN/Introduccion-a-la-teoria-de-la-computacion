...
\textbf{Punto 3:}(Los puntos de demostraciones serán realizados luego)\\
...
\begin{itemize}[label={✎}]
    ...
    \item Basta con realizar una construcción en paralelo para cada expresión de la unión.
...
\begin{itemize}[label={✎}]
    ...
    \item Observe que en este caso usaremos tanto la construcción paralela como la construcción en serie ya que uno de los caminos es relativamente complicado de construir pero con esta construcción es mucho mas sencillo.
