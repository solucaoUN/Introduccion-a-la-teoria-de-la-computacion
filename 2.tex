...
\textbf{Punto 3: }
\begin{itemize}[label={✎}]
    \item Considere el AFD $M_1$ que acepta $L_1$ (las cadenas de longitud par):
    \begin{basedtikz}
    \begin{tikzpicture}[node distance = 2.5cm, on grid, auto]
        \node (q0) [state, initial, accepting] {$q_0$};
        \node (q1) [state, right of=q0] {$q_1$};
...
\begin{basedtikz}
    ...
    \end{tikzpicture}
\end{basedtikz}
\item Considere el AFD $M_1$ que acepta $L_1$ (las cadenas de longitud impar):
    \begin{basedtikz}
    \begin{tikzpicture}[node distance = 2.5cm, on grid, auto]
        \node (q0) [state, initial] {$q_0$};
        \node (q1) [state, right of=q0, accepting] {$q_1$};
...
\end{basedtikz}
\end{itemize}
\textbf{Punto 4: }Por el teorema presentado en la sección sabemos que el conjunto que acepta $L_1-L_2$ es:
$$F_1\times(Q_2-F_2)$$
